...
router.post('oca', (req, res, next) => {
  const results = [];
  // Grab data from http request
  const data = {cid: req.body.cid, cname: req.body.cname, phone: req.body.phone, mail: req.body.mail, addr: req.body.addr, oid: req.body.oid};
  ...
  pg.connect(connectionString, (err, client, done) => {
    ...
    //const query = client.query('SELECT * FROM items customer BY id ASC');
